...
It's very important to test your verification rule set using both real live data and 'stubs'. Without doing this, potential problems can go unnoticed until it's too late. \<update links>

- [About real data testing](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-Aboutrealdatatesting)

- [About stubs testing](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-Aboutstubstesting)

  - [Turning on Stubs](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-TurningonStubs)

  - [Using Stubs](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-UsingStubs)

  - [Using stubs for New Zealand data sources](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-UsingstubsforNewZealanddatasources)

  - [Codes for background checks (Australia)](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-Codesforbackgroundchecks\(Australia\))

  - [Codes for background checks (New Zealand)](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-Codesforbackgroundchecks\(NewZealand\))

  - [Codes for interactive checks (Australia)](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-Codesforinteractivechecks\(Australia\))

  - [Codes for interactive checks (New Zealand)](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-Codesforinteractivechecks\(NewZealand\))

  - [Codes for the Credit Header checks](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-CodesfortheCreditHeaderchecks)

  - [Full or Partial Data Matches in Stubs](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-FullorPartialDataMatchesinStubs)

  - [Testing Lockout Functionality](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-TestingLockoutFunctionality)

  - [Testing greenID Alert Responses](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-TestinggreenIDAlertResponses)

  - [Testing GBG Alert (stubs mode)](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-TestingGBGAlert\(stubsmode\))

  - [Testing GBG Alert (non-stubs mode)](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-TestingGBGAlert\(non-stubsmode\))

  - [Visa Entitlement Check ](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/8880678/Data+Testing#DataTesting-VisaEntitlementCheck)
