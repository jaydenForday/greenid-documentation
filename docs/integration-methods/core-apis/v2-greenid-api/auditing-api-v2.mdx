...
This field will tell you whether the logged event was successful or not. There are a number of different possible results - refer to the [Individual Source States](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/17629486/Reference+Tables+V2#ReferenceTablesV2-IndividualSourceStates) reference table. 
