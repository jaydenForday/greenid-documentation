---
id: reference-tables-v5
title: Reference Tables V5
---
...
- [Overall Outcome States](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111401/Reference+Tables+V5#ReferenceTablesV5-OverallOutcomeStates)

- [Possible Modes](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111401/Reference+Tables+V5#ReferenceTablesV5-PossibleModes)

- [Individual Source States](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111401/Reference+Tables+V5#ReferenceTablesV5-IndividualSourceStates)

- [Method Names](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111401/Reference+Tables+V5#ReferenceTablesV5-MethodNames)

- [Field Status](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111401/Reference+Tables+V5#ReferenceTablesV5-FieldStatus)

- [DateTime specification](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111401/Reference+Tables+V5#ReferenceTablesV5-DateTimespecification)

  - [.NET and Date Types](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111401/Reference+Tables+V5#ReferenceTablesV5-.NETandDateTypes)

- [Street Types](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111401/Reference+Tables+V5#ReferenceTablesV5-StreetTypes)
...
| NOT\_FOUND\_ON\_LIST    | <p>This state is specific to the watchlist and GBG Alert checks.</p><p>**Watchlists:** The person was NOT found on a watchlist. **GBG Trust: Alert: **No configured GBG Trust: Alert rules were raised. See [GBG Trust: Alert Results](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2276556801/GBG+Trust+Alert+Results) (API v1-v4)</p>                                          | Not found on list       |
| FOUND\_ON\_LIST\*       | <p>This state is specific to the watchlist and GBG Trust: Alert checks.</p><p>**Watchlists:** The person found on a watchlist.**GBG Trust: Alert: **Configured GBG Trust: Alert rules were raised. Each rules raised will be listed separately. See: [GBG Trust: Alert Results](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2276556801/GBG+Trust+Alert+Results) (API v1-v4)</p> | Found on list           |
...
If you are not programmatically consuming the WSDL but are instead constructing the xml by hand then the Date must be of xs\:dateTime see [http://www.w3.org/TR/xmlschema-2/#dateTime](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111401/Reference+Tables+V5#ReferenceTablesV5-OverallOutcomeStates)

## .NET and Date Types{#ReferenceTablesV5-.NETandDateTypes}

**Please read this section if your development platform is .NET!**

Another important note is how .NET treats date/time types. When JBoss generates the WSDL for GreenID’s Web Services, the type “xs\:dateTime” is used to map the Java [java.util.Date](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111401/Reference+Tables+V5#ReferenceTablesV5-OverallOutcomeStates) class. This is not a problem if a Java platform is used to consume the WSDL, but .NET will behave in a slightly unexpected way.
...
For further information, the reader is referred to [http://msdn2.microsoft.com/en-us/library/ms973825.aspx](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111401/Reference+Tables+V5#ReferenceTablesV5-OverallOutcomeStates), and in particular, the section [http://msdn2.microsoft.com/en-us/library/ms973825.aspx#datetime\_topic4](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111401/Reference+Tables+V5#ReferenceTablesV5-OverallOutcomeStates).
