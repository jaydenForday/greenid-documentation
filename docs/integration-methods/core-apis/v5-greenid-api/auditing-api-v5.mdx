...
- [Purpose of the API](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111458/Auditing+API+V5#AuditingAPIV5-PurposeoftheAPI)

- [Getting Started](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111458/Auditing+API+V5#AuditingAPIV5-GettingStarted)

- [How to Use the API](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111458/Auditing+API+V5#AuditingAPIV5-HowtoUsetheAPI)

  - [API Parameters](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111458/Auditing+API+V5#AuditingAPIV5-APIParameters)

- [Interpreting Results](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111458/Auditing+API+V5#AuditingAPIV5-InterpretingResults)

  - [Interpreting audit logs](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111458/Auditing+API+V5#AuditingAPIV5-Interpretingauditlogs)

    - [Possible 'datasourceattempt' Sub-Codes](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111458/Auditing+API+V5#AuditingAPIV5-Possible'datasourceattempt'Sub-Codes)

    - [Possible "webservice" Sub Codes](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111458/Auditing+API+V5#AuditingAPIV5-Possible%22webservice%22SubCodes)

- [Event Statuses](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111458/Auditing+API+V5#AuditingAPIV5-EventStatuses)
...
## API Parameters{#AuditingAPIV5-APIParameters}
...
## Interpreting audit logs{#AuditingAPIV5-Interpretingauditlogs}
...
### Possible 'datasourceattempt' Sub-Codes{#AuditingAPIV5-Possible'datasourceattempt'Sub-Codes}
...
### Possible "webservice" Sub Codes{#AuditingAPIV5-Possible"webservice"SubCodes}
...
This field will tell you whether the logged event was successful or not.  There are a number of different possible results - refer to the [Individual Source States](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2310111401/Reference+Tables+V5#ReferenceTablesV5-IndividualSourceStates) reference table. 
