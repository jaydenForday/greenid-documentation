---
id: background-checks-v3
title: Background Checks V3
sidebar_position: 8
---

# Background Checks V3
...
## Background DVS Driver's Licence Checks{#BackgroundChecksV3-BackgroundDVSDriver'sLicenceChecks}
...
- driversCardNumber - the driver's licence card number, exactly as it appears on the licence. Card number is a mandatory field for some states, please refer to our FAQ: [DVS Driver Licence Card Number Change - FAQ Sheet](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/2130247708/DVS+Driver+Licence+Card+Number+Change+-+FAQ+Sheet).

## Background DVS Medicare Card Checks{#BackgroundChecksV3-BackgroundDVSMedicareCardChecks}
...
## Background DVS Australian Passport Checks{#BackgroundChecksV3-BackgroundDVSAustralianPassportChecks}
...
## Background DVS Visa Checks{#BackgroundChecksV3-BackgroundDVSVisaChecks}
...
## Background DVS Australian Electoral Roll Checks (AEC){#BackgroundChecksV3-BackgroundDVSAustralianElectoralRollChecks(AEC)}
...
## Background NZ Driver's Licence Checks{#BackgroundChecksV3-BackgroundNZDriver'sLicenceChecks}
...
## Background NZ Passport Checks{#BackgroundChecksV3-BackgroundNZPassportChecks}
...
The result of the background driver's licence check will be returned in the standard `VerificationResultV3` element returned by the web service call (either the regular greenID web services, or the greenID API).
