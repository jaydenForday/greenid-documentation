...
Open image-20230427-070207.png
...
Open image-20230427-070621.png
...
| -------------------- | -------------------- | ------------------------------------------------------------------ |
| setFields            | Visa                 | <p>Open setFields - Visa.png</p><p> </p>                           |
| setFields            | Marriage Certificate | Open setFields - Marriage Certificate.png                          |
| setFields            | Birth Certificate    | Open setFields - Birth Certificate.png                             |
| registerVerification | NSW DL               | Open registerVerification - NSW DL.png                             |
| registerVerification | ACT DL               | <p>Open registerVerification - ACT DL - Name Match.png</p><p> </p> |
| registerVerification | ACT DL               | Open registerVerification - ACT DL.png                             |
| registerVerification | Passport             | Open registerVeirfication - Passport.png                           |
