...
**Note:** This Admin Panel user guide does not explain how to use greenID Business. Please refer to the [greenID Business User Guide](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/491652037/greenID+Business+Admin+Panel+User+Guide) for admin panel features specific to greenID Business.
...
\<these links need updating and FAQ questions moved>

- [Accessing the Admin Panel](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-AccessingtheAdminPanel)

  - [What is the URL of my admin panel?](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-WhatistheURLofmyadminpanel%3F)

  - [When I try to access the Admin Panel, my browser reports page not found?](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-WhenItrytoaccesstheAdminPanel%2Cmybrowserreportspagenotfound%3F)

- [Searching](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-Searching)

  - [How do I lookup/search for previous customer records?](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-HowdoIlookup%2Fsearchforpreviouscustomerrecords%3F)

  - [How do I search for a particular record?](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-HowdoIsearchforaparticularrecord%3F)

  - [I cannot find a particular customer record however I know they have been registered with greenID](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-IcannotfindaparticularcustomerrecordhoweverIknowtheyhavebeenregisteredwithgreenID)

  - [Can I search for records in a set period or by outcome?](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-CanIsearchforrecordsinasetperiodorbyoutcome%3F)

- [Reporting](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-Reporting)

  - [Can I export my search results?](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-CanIexportmysearchresults%3F)

  - [Can I export a PDF copy of the results of a particular record?](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-CanIexportaPDFcopyoftheresultsofaparticularrecord%3F)

  - [I don’t see an export option after performing a search on previous transactions](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-Idon%E2%80%99tseeanexportoptionafterperformingasearchonprevioustransactions)

  - [How long do you keep the records/results?](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-Howlongdoyoukeeptherecords%2Fresults%3F)

  - [Can we purge / delete data after a set period?](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-Canwepurge%2Fdeletedataafterasetperiod%3F)

- [Results](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-Results)

  - [What do the various status outcomes mean?](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-Whatdothevariousstatusoutcomesmean%3F)

  - [What is the blue exclamation mark beside the data source found when looking to a particular customers verification outcome?](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-Whatistheblueexclamationmarkbesidethedatasourcefoundwhenlookingtoaparticularcustomersverificationoutcome%3F)

  - [How can a customer be verified using a different first name than the one they initially registered with?](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-Howcanacustomerbeverifiedusingadifferentfirstnamethantheonetheyinitiallyregisteredwith%3F)

  - [What rule is configured on the account?](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-Whatruleisconfiguredontheaccount%3F)

- [Data Sources](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/14286881/Admin+Panel+Guide#AdminPanelGuide-DataSources)



- [Batch Processing - How to](https://vixverify.atlassian.net/wiki/spaces/GREEN/pages/702808200/Batch+Processing+via+the+greenID+Admin+Panel)
...
\
**[Production](mailto\:customer.support@gbgplc.com) server:**\
